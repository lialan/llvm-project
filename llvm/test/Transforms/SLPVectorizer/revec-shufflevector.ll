...
; CHECK-NEXT:    [[TMP5:%.*]] = zext <8 x i32> [[TMP0]] to <8 x i64>
...
; COMBINE-NEXT:    [[TMP5:%.*]] = zext <8 x i32> [[TMP0]] to <8 x i64>
...
; CHECK-NEXT:    [[TMP25:%.*]] = zext <16 x i8> [[LOAD5]] to <16 x i16>
...
; COMBINE-NEXT:    [[TMP25:%.*]] = zext <16 x i8> [[LOAD5]] to <16 x i16>
